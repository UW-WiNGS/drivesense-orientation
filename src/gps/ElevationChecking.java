...
//	private static String databasePath = "C:/Users/Bozhao Qi/Dropbox/OBD/data/roadsegments/elevation/bozhao/urban/";
	...
	public static void start() {
		...
		List<Trace> speed = ReadWriteTrace.readFile(folder.concat("speed.dat"), 1);
//		List<Trace> spds = PreProcess.interpolate(speed, 1.0);
		List<Trace> gps_db = ReadWriteTrace.readFile(databasePath.concat("gps_elevationDB.dat"), 3);
